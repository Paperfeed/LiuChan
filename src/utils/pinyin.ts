...
export function zhuyinFromPinyin(pinyin: string, tone: number): string {
  if (pinyin in zhuyinMap) {
...
export function toneMarksFromPinyin(pinyin: string, tone: number): string {
  if (pinyin.indexOf('a') !== -1) {
    return pinyin.replace('a', toneCharMap.a[tone - 1])
  }
  if (pinyin.indexOf('e') !== -1) {
    return pinyin.replace('e', toneCharMap.e[tone - 1])
  }
  if (pinyin.indexOf('ou') !== -1) {
    return pinyin.replace('o', toneCharMap.o[tone - 1])
  }
  ...
  return pinyin
    ...
    .map((letter) => {
      if (isVowel(letter)) {
        switch (letter) {
          case 'i':
            return toneCharMap.i[tone - 1]
          case 'o':
            return toneCharMap.o[tone - 1]
          case 'u':
